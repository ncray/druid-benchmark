...
group_by_suppkey SELECT SUM(L_QUANTITY), SUM(L_EXTENDEDPRICE) FROM [druid-benchmarking.tpc_h.tbl] WHERE TIMESTAMP(L_SHIPDATE) BETWEEN TIMESTAMP('1996-01-15') AND TIMESTAMP('1998-03-15') GROUP BY L_SUPPKEY;
